...
export default function SubHero() {
  return (
    <>
      <section
        className='bg-[#231f20] max-w-7xl mx-auto relative z-10 py-12 px-4 sm:px-6 lg:px-8'
      ...
      >
        ...
        <div className='max-w-xl mx-auto rounded-2xl'>
          <div className='flex flex-col border-2 border-[#d31e28] rounded-2xl shadow-xl'>
            <div className='flex-1 relative pt-16 px-6 pb-8 md:px-8'>
              ...
              <ul className='text-white text-right pt-6'>
                <li>
                  Mon -
                  <time dateTime={data.seoHours.monday}>
                    {data.hours.monday}
                  </time>
                </li>
                <li>
                  Tue -
                  <time dateTime={data.seoHours.tuesday}>
                    {data.hours.tuesday}
                  </time>
                </li>
                <li>
                  Wed -
                  <time dateTime={data.seoHours.wednesday}>
                    {data.hours.wednesday}
                  </time>
                </li>
                <li>
                  Thu -
                  <time dateTime={data.seoHours.thursday}>
                    {data.hours.thursday}
                  </time>
                </li>
                <li>
                  Fri -
                  <time dateTime={data.seoHours.friday}>
                    {data.hours.friday}
                  </time>
                </li>
                <li>
                  Sat -
                  <time dateTime={data.seoHours.saturday}>
                    {data.hours.saturday}
                  </time>
                </li>
                <li>
                  Sun -
                  <time dateTime={data.seoHours.sunday}>
                    {data.hours.sunday}
                  </time>
                </li>
              </ul>
            ...
            <div className='p-6 rounded-bl-2xl rounded-br-2xl md:px-8'>
              <ul className='flex'>
                <li className='p-2'>
                  ...
                  >
                    <svg
                      className='fill-current text-zinc-700 hover:text-red-700'
      ...
      <section className='bg-[#231f20] max-w-7xl mx-auto relative z-10 py-12 px-4 sm:px-6 lg:px-8'>
        <h2 className='text-xl font-bold text-white text-center'>Menu</h2>
        <iframe
          src='/Images/menu.pdf#toolbar=0'
          className='mx-auto'
          width='75%'
          height='900px'
        ></iframe>
