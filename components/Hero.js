    ...
    <div className='relative bg-[#231f20] overflow-hidden'>
      <div className='max-w-7xl mx-auto'>
        <div className='relative z-10 pb-8 bg-[#231f20] sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32'>
          ...
          <div className='relative pt-6 px-6 sm:px-6 lg:px-12'>
            <img src='/Images/blast&brew-2022.jpg' alt='Blast & Brew' />
          </div>
          <main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
            <div className='sm:text-center lg:text-left'>
              ...
              <p className='mt-3 pr-4 text-base text-white sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0'>
                Located within walking distance of the pier, our Pismo Blast &
                Brew is a great place to enjoy a tasty meal and cold brew with a
                fantastic view of the beach. We&apos;re open for lunch and
                dinner, and can&apos;t wait to serve you.
              </p>
            </div>
          </main>
        </div>
